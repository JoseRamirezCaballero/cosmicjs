    ...
    <>
      ...
      <div className='relative px-4 pb-4 mx-auto h-full flex flex-col justify-center items-center text-black bg-white'>
        ...
        <TypeAnimation
          ...
          deletionSpeed={90}
          repeat={Infinity}
          className='mt-8 text-lg font-normal text-black sm:text-xl z-10'
        />
        <div className='flex flex-col mt-8 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4 z-5'>
          ...
          <Link href='/about' className='inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center rounded-lg bg-white border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-400'>
            <span className="text-gray-900 hover:text-gray-700">Conócenos</span>
          </Link>
